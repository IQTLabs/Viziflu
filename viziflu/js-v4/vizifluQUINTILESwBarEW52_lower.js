function vizifluChartLower() {
  ...
  var width = (0.95*(innerWidth)) - margin.left - margin.right;
  ...
  function chart(selection) {
    selection.each(function drawGraph(dataset) {
      ...
      legend
        ...
        .attr("height", 7)
        .attr("width", 7)
        .attr("class", "no_chance_peakweek_forecast_data");
      ...
      legend
        ...
        .attr("height", 9)
        .attr("width", 9)
        .attr("class", "negligible_chance_peakweek_forecast_data");
      ...
      legend
        ...
        .attr("height", 13)
        .attr("width", 13)
        .attr("class", "low_chance_peakweek_forecast_data"); //what is this?
      ...
      legend
        ...
        .attr("height", 13)
        .attr("width", 13)
        .attr("class", "moderate_chance_peakweek_forecast_data"); //what is this?
      ...
      legend
        ...
        .attr("height", 13)
        .attr("width", 13)
        .attr("class", "foreseeable_chance_peakweek_forecast_data"); //what is this?
      ...
      legend
        ...
        .attr("height", 18)
        .attr("width", 18)
        .attr("class", "high_chance_peakweek_forecast_data"); //what is this?

      legend
        .append("text")
        .attr("x", width + margin.right - 120 + 25)
        .attr("y", paddingTopHeading + 8.5)
        .text("50-100%")
        .attr("class", "legend");
    });
